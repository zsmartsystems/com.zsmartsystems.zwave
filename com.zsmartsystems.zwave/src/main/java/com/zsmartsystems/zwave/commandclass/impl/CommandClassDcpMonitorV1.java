...
public class CommandClassDcpMonitorV1 {
    ...
    /**
     * Map holding constants for Event status
     */
    private static Map<Integer, String> constantEventStatus = new HashMap<Integer, String>();
    static {

        // Constants for Event status
        constantEventStatus.put(0x01, "EVENT_STARTED");
        constantEventStatus.put(0x02, "EVENT_COMPLETED");
        constantEventStatus.put(0x03, "EVENT_REJECTED");
        constantEventStatus.put(0x04, "EVENT_NOT_APPLICABLE");
    }
    ...
    static public byte[] getDcpEventStatusReport(Integer year, Integer month, Integer day, Integer hourLocalTime,
        ...
        for (Integer entry : constantEventStatus.keySet()) {
            if (constantEventStatus.get(entry).equals(eventStatus)) {
    ...
    public static Map<String, Object> handleDcpEventStatusReport(byte[] payload) {
        ...
        // Process 'Event status'
        response.put("EVENT_STATUS", constantEventStatus.get(payload[9] & 0xff));
