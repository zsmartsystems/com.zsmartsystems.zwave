...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_REMOTE_ASSOCIATION_ACTIVATE</b> version <b>1</b>.<br>
 *
 * Command Class Remote Association Activate<br>
 *
...
public class CommandClassRemoteAssociationActivateV1 {
    ...
    /**
     * Creates a new message with the REMOTE_ASSOCIATION_ACTIVATE command.<br>
     *
     * Remote Association Activate<br>
     *
     *
    ...
    /**
     * Processes a received frame with the REMOTE_ASSOCIATION_ACTIVATE command<br>
     *
     * Remote Association Activate<br>
     *
     *
