...
public class CommandClassSecurityPanelZoneV1 {
    ...
    /**
     * Map holding constants for Parameters1
     */
    private static Map<Integer, String> constantParameters1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for Zone State
     */
    private static Map<Integer, String> constantZoneState = new HashMap<Integer, String>();

    /**
     * Map holding constants for Zone Type
     */
    private static Map<Integer, String> constantZoneType = new HashMap<Integer, String>();
    static {

        // Constants for Parameters1
        constantParameters1.put(0x80, "ZM");

        // Constants for Zone State
        constantZoneState.put(0x00, "FAULTED");
        constantZoneState.put(0x01, "NOT_FAULTED");
        constantZoneState.put(0x02, "BYPASS_FAULTED");
        constantZoneState.put(0x03, "BYPASS_NOT_FAULTED");

        // Constants for Zone Type
        constantZoneType.put(0x01, "ALARM_ZONE");
        constantZoneType.put(0x02, "NOTIFICATION_ZONE");
    }
    ...
    static public byte[] getSecurityPanelZoneTypeReport(Integer zoneNumber, String zoneType) {
        ...
        for (Integer entry : constantZoneType.keySet()) {
            if (constantZoneType.get(entry).equals(zoneType)) {
    ...
    public static Map<String, Object> handleSecurityPanelZoneTypeReport(byte[] payload) {
        ...
        // Process 'Zone Type'
        response.put("ZONE_TYPE", constantZoneType.get(payload[3] & 0xff));
    ...
    static public byte[] getSecurityPanelZoneStateReport(Integer zoneNumber, String zoneState) {
        ...
        for (Integer entry : constantZoneState.keySet()) {
            if (constantZoneState.get(entry).equals(zoneState)) {
                outputData.write(entry);
                foundZoneState = true;
                break;
            }
    ...
    public static Map<String, Object> handleSecurityPanelZoneStateReport(byte[] payload) {
        ...
        // Process 'Zone State'
        response.put("ZONE_STATE", constantZoneState.get(payload[3] & 0xff));
