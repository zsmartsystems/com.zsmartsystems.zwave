...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_DMX</b> version <b>1</b>.<br>
 *
 * Command Class DMX<br>
 *
...
public class CommandClassDmxV1 {
    ...
    /**
     * Creates a new message with the DMX_ADDRESS_SET command.<br>
     *
     * DMX Address Set<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DMX_ADDRESS_SET command<br>
     *
     * DMX Address Set<br>
     *
     *
    ...
    /**
     * Creates a new message with the DMX_ADDRESS_GET command.<br>
     *
     * DMX Address Get<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DMX_ADDRESS_GET command<br>
     *
     * DMX Address Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the DMX_ADDRESS_REPORT command.<br>
     *
     * DMX Address Report<br>
     *
     *
     * @param pageId {@link Integer}
     * @param channelId {@link Integer}
    ...
    /**
     * Processes a received frame with the DMX_ADDRESS_REPORT command<br>
     *
     * DMX Address Report<br>
     *
     *
    ...
    /**
     * Creates a new message with the DMX_CAPABILITY_GET command.<br>
     *
     * DMX Capability Get<br>
     *
     *
     * @param channelId {@link Integer}
     * @return the {@link byte[]} array with the command to send
    ...
    /**
     * Processes a received frame with the DMX_CAPABILITY_GET command<br>
     *
     * DMX Capability Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the DMX_CAPABILITY_REPORT command.<br>
     *
     * DMX Capability Report<br>
     *
     *
     * @param channelId {@link Integer}
    ...
    /**
     * Processes a received frame with the DMX_CAPABILITY_REPORT command<br>
     *
     * DMX Capability Report<br>
     *
     *
    ...
    /**
     * Creates a new message with the DMX_DATA command.<br>
     *
     * DMX Data<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DMX_DATA command<br>
     *
     * DMX Data<br>
     *
     *
