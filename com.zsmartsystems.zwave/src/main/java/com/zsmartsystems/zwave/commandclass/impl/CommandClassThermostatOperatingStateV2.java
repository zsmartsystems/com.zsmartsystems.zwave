...
public class CommandClassThermostatOperatingStateV2 {
    ...
    static {
        ...
        constantBitMask.put(0x00, "IDLE");
        constantBitMask.put(0x01, "HEATING");
        constantBitMask.put(0x02, "COOLING");
        constantBitMask.put(0x03, "FAN_ONLY");
        constantBitMask.put(0x04, "PENDING_HEAT");
        constantBitMask.put(0x05, "PENDING_COOL");
        constantBitMask.put(0x06, "VENT_ECONOMIZER");
        constantBitMask.put(0x07, "AUX_HEATING");
        constantBitMask.put(0x08, "2ND_STAGE_HEATING");
        constantBitMask.put(0x09, "2ND_STAGE_COOLING");
        constantBitMask.put(0x0A, "2ND_STAGE_AUX_HEAT");
        constantBitMask.put(0x0B, "3RD_STAGE_AUX_HEAT");
    }
