...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_NOTIFICATION</b> version <b>8</b>.
 * <p>
...
public class CommandClassNotificationV8 {
    ...
    static {
        ...
        constantNotificationType.put(0x0F, "WATER_VALVE");
        constantNotificationType.put(0x11, "IRRIGATION");
        constantNotificationType.put(0x10, "WEATHER_ALARM");
        constantNotificationType.put(0x12, "GAS_ALARM");
        ...
        constantBitMask.put(0x0F, "WATER_VALVE");
        constantBitMask.put(0x11, "IRRIGATION");
        constantBitMask.put(0x10, "WEATHER_ALARM");
        constantBitMask.put(0x12, "GAS_ALARM");
    }
