...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_WAKE_UP</b> version <b>2</b>.<br>
 *
...
public class CommandClassWakeUpV2 {
    ...
    /**
     * Creates a new message with the WAKE_UP_INTERVAL_CAPABILITIES_GET command.<br>
     *
     * Wake Up Interval Capabilities Get<br>
     *
     *
     * @return the {@link byte[]} array with the command to send
     */
    ...
    /**
     * Processes a received frame with the WAKE_UP_INTERVAL_CAPABILITIES_GET command<br>
     *
     * Wake Up Interval Capabilities Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the WAKE_UP_INTERVAL_CAPABILITIES_REPORT command.<br>
     *
     * Wake Up Interval Capabilities Report<br>
     *
     *
     * @return the {@link byte[]} array with the command to send
     */
    ...
    /**
     * Processes a received frame with the WAKE_UP_INTERVAL_CAPABILITIES_REPORT command<br>
     *
     * Wake Up Interval Capabilities Report<br>
     *
     *
