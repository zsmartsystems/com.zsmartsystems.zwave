...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_ZIP</b> version <b>3</b>.<br>
 *
...
public class CommandClassZipV3 {
    ...
    public static Map<String, Object> handleCommandZipPacket(byte[] payload) {
        ...
        // Process 'Properties2'
        response.put("SECURE_ORIGIN", new Boolean((payload[msgOffset] & 0x10) != 0));
        ...
        // Process 'Header Length'
        response.put("HEADER_LENGTH", new Integer(payload[msgOffset]));
        msgOffset += 1;
