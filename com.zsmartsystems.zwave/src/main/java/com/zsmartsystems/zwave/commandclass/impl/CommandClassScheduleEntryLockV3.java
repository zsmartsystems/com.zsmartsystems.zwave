...
public class CommandClassScheduleEntryLockV3 {
     ...
     */
    private static Map<Integer, String> constantScheduleEntryLockDailyRepeatingSetSetAction = new HashMap<Integer, String>();
    ...
    static public byte[] getScheduleEntryLockDailyRepeatingSet(String setAction, Integer userIdentifier,
        ...
        // Process 'Set Action'
        boolean foundSetAction = false;
        for (Integer entry : constantScheduleEntryLockDailyRepeatingSetSetAction.keySet()) {
            if (constantScheduleEntryLockDailyRepeatingSetSetAction.get(entry).equals(setAction)) {
                outputData.write(entry);
                foundSetAction = true;
                break;
            }
    ...
    public static Map<String, Object> handleScheduleEntryLockDailyRepeatingSet(byte[] payload) {
        ...
        // Process 'Set Action'
        response.put("SET_ACTION", constantScheduleEntryLockDailyRepeatingSetSetAction.get(payload[2] & 0xff));
