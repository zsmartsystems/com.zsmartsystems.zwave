...
public class CommandClassThermostatFanModeV4 {
    ...
    static {
        ...
        constantProperties1.put(0x80, "OFF");

        // Constants for Bit Mask
        constantBitMask.put(0x00, "AUTO");
        constantBitMask.put(0x01, "LOW");
        constantBitMask.put(0x02, "AUTO_HIGH");
        constantBitMask.put(0x03, "HIGH");
        constantBitMask.put(0x04, "AUTO_MEDIUM");
        constantBitMask.put(0x05, "MEDIUM");
        constantBitMask.put(0x06, "CIRCULATION");
        constantBitMask.put(0x07, "HUMIDITY_CIRCULATION");
        constantBitMask.put(0x08, "LEFT_RIGHT");
        constantBitMask.put(0x09, "UP_DOWN");
        constantBitMask.put(0x0A, "QUIET");
    }
