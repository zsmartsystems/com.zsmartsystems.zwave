...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_MULTI_CHANNEL</b> version <b>3</b>.
 * <p>
 ...
 */
public class CommandClassMultiChannelV3 {
    private static final Logger logger = LoggerFactory.getLogger(CommandClassMultiChannelV3.class);
     ...
     */
    private static Map<Integer, String> constantMultiChannelCapabilityReportProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiChannelCmdEncapProperties1
     */
    private static Map<Integer, String> constantMultiChannelCmdEncapProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiChannelCmdEncapProperties2
     */
    private static Map<Integer, String> constantMultiChannelCmdEncapProperties2 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiInstanceReportProperties1
     */
    private static Map<Integer, String> constantMultiInstanceReportProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiChannelEndPointReportProperties1
     */
    private static Map<Integer, String> constantMultiChannelEndPointReportProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiChannelCapabilityGetProperties1
     */
    private static Map<Integer, String> constantMultiChannelCapabilityGetProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiInstanceCmdEncapProperties1
     */
    private static Map<Integer, String> constantMultiInstanceCmdEncapProperties1 = new HashMap<Integer, String>();

    /**
     * Map holding constants for MultiChannelEndPointFindReportProperties1
     */
    private static Map<Integer, String> constantMultiChannelEndPointFindReportProperties1 = new HashMap<Integer, String>();
    ...
    static {
        ...
        // Constants for MultiChannelCmdEncapProperties1
        constantMultiChannelCmdEncapProperties1.put(0x80, "RES");

        // Constants for MultiChannelCmdEncapProperties2
        constantMultiChannelCmdEncapProperties2.put(0x80, "BIT_ADDRESS");

        // Constants for MultiInstanceReportProperties1
        constantMultiInstanceReportProperties1.put(0x80, "RES");

        // Constants for MultiChannelEndPointReportProperties1
        constantMultiChannelEndPointReportProperties1.put(0x40, "IDENTICAL");
        constantMultiChannelEndPointReportProperties1.put(0x80, "DYNAMIC");

        // Constants for MultiChannelCapabilityGetProperties1
        constantMultiChannelCapabilityGetProperties1.put(0x80, "RES");

        // Constants for MultiInstanceCmdEncapProperties1
        constantMultiInstanceCmdEncapProperties1.put(0x80, "RES");

        // Constants for MultiChannelEndPointFindReportProperties1
        constantMultiChannelEndPointFindReportProperties1.put(0x80, "RES");

        // Constants for MultiChannelEndPointReportProperties2
        constantMultiChannelEndPointReportProperties2.put(0x80, "RES2");
    }
    ...
    static public byte[] getMultiInstanceGet(Integer commandClass) {
        logger.debug("Creating command message MULTI_INSTANCE_GET version 3");
    ...
    static public byte[] getMultiInstanceReport(Integer commandClass, Integer instances, Boolean res) {
        logger.debug("Creating command message MULTI_INSTANCE_REPORT version 3");
    ...
    static public byte[] getMultiInstanceCmdEncap(Integer instance, Boolean res, Integer commandClass, Integer command,
            int[] parameter) {
        logger.debug("Creating command message MULTI_INSTANCE_CMD_ENCAP version 3");
    ...
    static public byte[] getMultiChannelEndPointGet() {
        logger.debug("Creating command message MULTI_CHANNEL_END_POINT_GET version 3");
    ...
    static public byte[] getMultiChannelEndPointReport(Integer res1, Boolean identical, Boolean dynamic,
        ...
        logger.debug("Creating command message MULTI_CHANNEL_END_POINT_REPORT version 3");
    ...
    static public byte[] getMultiChannelCapabilityGet(Integer endPoint, Boolean res) {
        logger.debug("Creating command message MULTI_CHANNEL_CAPABILITY_GET version 3");
    ...
    static public byte[] getMultiChannelCapabilityReport(Integer endPoint, Boolean dynamic, Integer genericDeviceClass,
        ...
        logger.debug("Creating command message MULTI_CHANNEL_CAPABILITY_REPORT version 3");
    ...
    static public byte[] getMultiChannelEndPointFind(Integer genericDeviceClass, Integer specificDeviceClass) {
        logger.debug("Creating command message MULTI_CHANNEL_END_POINT_FIND version 3");
    ...
    static public byte[] getMultiChannelEndPointFindReport(Integer reportsToFollow, Integer genericDeviceClass,
        ...
        logger.debug("Creating command message MULTI_CHANNEL_END_POINT_FIND_REPORT version 3");
    ...
    static public byte[] getMultiChannelCmdEncap(Integer sourceEndPoint, Boolean res, Integer destinationEndPoint,
        ...
        logger.debug("Creating command message MULTI_CHANNEL_CMD_ENCAP version 3");
