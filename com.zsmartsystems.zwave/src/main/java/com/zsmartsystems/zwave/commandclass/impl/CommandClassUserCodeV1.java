...
public class CommandClassUserCodeV1 {
     ...
     */
    private static Map<Integer, String> constantUserCodeReportUserIdStatus = new HashMap<Integer, String>();
    ...
    static {
        ...
        constantUserCodeReportUserIdStatus.put(0x01, "OCCUPIED");

        // Constants for UserCodeSetUserIdStatus
        constantUserCodeSetUserIdStatus.put(0xFE, "STATUS_NOT_AVAILABLE");
        constantUserCodeSetUserIdStatus.put(0x00, "AVAILABLE");
        constantUserCodeSetUserIdStatus.put(0x01, "OCCUPIED");
    }
    ...
    static public byte[] getUserCodeSet(Integer userIdentifier, String userIdStatus, byte[] userCode) {
        ...
        for (Integer entry : constantUserCodeSetUserIdStatus.keySet()) {
            if (constantUserCodeSetUserIdStatus.get(entry).equals(userIdStatus)) {
    ...
    public static Map<String, Object> handleUserCodeSet(byte[] payload) {
        ...
        // Process 'User ID Status'
        response.put("USER_ID_STATUS", constantUserCodeSetUserIdStatus.get(payload[3] & 0xff));
    ...
    static public byte[] getUserCodeReport(Integer userIdentifier, String userIdStatus, byte[] userCode) {
        ...
        // Process 'User ID Status'
        boolean foundUserIdStatus = false;
        for (Integer entry : constantUserCodeReportUserIdStatus.keySet()) {
            if (constantUserCodeReportUserIdStatus.get(entry).equals(userIdStatus)) {
                outputData.write(entry);
                foundUserIdStatus = true;
                break;
            }
    ...
    public static Map<String, Object> handleUserCodeReport(byte[] payload) {
        ...
        // Process 'User ID Status'
        response.put("USER_ID_STATUS", constantUserCodeReportUserIdStatus.get(payload[3] & 0xff));
