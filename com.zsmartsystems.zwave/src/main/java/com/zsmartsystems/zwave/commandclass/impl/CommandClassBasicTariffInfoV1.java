...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_BASIC_TARIFF_INFO</b> version <b>1</b>.<br>
 *
 * Command Class Basic Tariff Info<br>
 *
...
public class CommandClassBasicTariffInfoV1 {
    ...
    /**
     * Creates a new message with the BASIC_TARIFF_INFO_GET command.<br>
     *
     * Basic Tariff Info Get<br>
     *
     *
    ...
    /**
     * Processes a received frame with the BASIC_TARIFF_INFO_GET command<br>
     *
     * Basic Tariff Info Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the BASIC_TARIFF_INFO_REPORT command.<br>
     *
     * Basic Tariff Info Report<br>
     *
     *
    ...
    /**
     * Processes a received frame with the BASIC_TARIFF_INFO_REPORT command<br>
     *
     * Basic Tariff Info Report<br>
     *
     *
