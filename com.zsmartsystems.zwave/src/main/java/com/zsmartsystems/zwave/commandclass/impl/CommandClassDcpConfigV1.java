...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_DCP_CONFIG</b> version <b>1</b>.<br>
 *
 * Command Class Dcp Config<br>
 *
...
public class CommandClassDcpConfigV1 {
    ...
    /**
     * Creates a new message with the DCP_LIST_SUPPORTED_GET command.<br>
     *
     * Dcp List Supported Get<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DCP_LIST_SUPPORTED_GET command<br>
     *
     * Dcp List Supported Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the DCP_LIST_SUPPORTED_REPORT command.<br>
     *
     * Dcp List Supported Report<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DCP_LIST_SUPPORTED_REPORT command<br>
     *
     * Dcp List Supported Report<br>
     *
     *
    ...
    public static Map<String, Object> handleDcpListSupportedReport(byte[] payload) {
        ...
        // Process 'DCP List Size'
        response.put("DCP_LIST_SIZE", new Integer(payload[2]));

        // Process 'Free DCP List entries'
        response.put("FREE_DCP_LIST_ENTRIES", new Integer(payload[3]));
    ...
    /**
     * Creates a new message with the DCP_LIST_SET command.<br>
     *
     * Dcp List Set<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DCP_LIST_SET command<br>
     *
     * Dcp List Set<br>
     *
     *
    ...
    public static Map<String, Object> handleDcpListSet(byte[] payload) {
        ...
        // Process 'DCP Rate ID'
        response.put("DCP_RATE_ID", new Integer(payload[9]));

        // Process 'Properties1'
        response.put("NUMBER_OF_DC", new Integer(payload[10] & 0x03));
        ...
        while (offset < payload.length) {
            ...
            variant.put("GENERIC_DEVICE_CLASS", new Integer(payload[11]));

            // Process 'Specific Device Class'
            variant.put("SPECIFIC_DEVICE_CLASS", new Integer(payload[12]));
        ...
        // Process 'Start Year'
        response.put("START_YEAR", new Integer(payload[13] << 8 + payload[14]));

        // Process 'Start Month'
        response.put("START_MONTH", new Integer(payload[15]));

        // Process 'Start Day'
        response.put("START_DAY", new Integer(payload[16]));

        // Process 'Start Hour Local Time'
        response.put("START_HOUR_LOCAL_TIME", new Integer(payload[17]));

        // Process 'Start Minute Local Time'
        response.put("START_MINUTE_LOCAL_TIME", new Integer(payload[18]));

        // Process 'Start Second Local Time'
        response.put("START_SECOND_LOCAL_TIME", new Integer(payload[19]));

        // Process 'Duration Hour Time'
        response.put("DURATION_HOUR_TIME", new Integer(payload[20]));

        // Process 'Duration Minute Time'
        response.put("DURATION_MINUTE_TIME", new Integer(payload[21]));

        // Process 'Duration Second Time'
        response.put("DURATION_SECOND_TIME", new Integer(payload[22]));

        // Process 'Event Priority'
        response.put("EVENT_PRIORITY", new Integer(payload[23]));

        // Process 'Load shedding'
        response.put("LOAD_SHEDDING", new Integer(payload[24]));

        // Process 'Start Association Group'
        response.put("START_ASSOCIATION_GROUP", new Integer(payload[25]));

        // Process 'Stop Association Group'
        response.put("STOP_ASSOCIATION_GROUP", new Integer(payload[26]));

        // Process 'Randomization interval'
        response.put("RANDOMIZATION_INTERVAL", new Integer(payload[27]));
    ...
    /**
     * Creates a new message with the DCP_LIST_REMOVE command.<br>
     *
     * Dcp List Remove<br>
     *
     *
    ...
    /**
     * Processes a received frame with the DCP_LIST_REMOVE command<br>
     *
     * Dcp List Remove<br>
     *
     *
