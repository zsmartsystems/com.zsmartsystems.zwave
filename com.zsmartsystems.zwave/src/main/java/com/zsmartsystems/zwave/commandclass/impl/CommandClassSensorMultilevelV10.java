...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_SENSOR_MULTILEVEL</b> version <b>10</b>.<br>
 *
...
public class CommandClassSensorMultilevelV10 {
    ...
    static public byte[] getSensorMultilevelSupportedSensorReport(List<String> bitMask) {
        ...
        valBitMask |= (bitMask.contains("PARTICULATE_MATTER") ? 0x08 : 0);
        valBitMask |= (bitMask.contains("RESPIRATORY_RATE") ? 0x10 : 0);
        outputData.write(valBitMask);
        ...
        while (cntBitMask < payload.length - 2) {
            ...
            switch (cntBitMask) {
                ...
                case 0x3A:
                    ...
                    break;
                case 0x3B:
                    responseBitMask.add("PARTICULATE_MATTER");
                    break;
                case 0x3C:
                    responseBitMask.add("RESPIRATORY_RATE");
                    break;
                default:
    ...
    static public byte[] getSensorMultilevelSupportedGetScale(String sensorType) {
        ...
        switch (sensorType) {
            ...
            case "ACCELERATION_X_AXIS":
                outputData.write(0x34);
                break;
            case "ACCELERATION_Y_AXIS":
                outputData.write(0x35);
                break;
            case "ACCELERATION_Z_AXIS":
                outputData.write(0x36);
                break;
            case "SMOKE_DENSITY":
                outputData.write(0x37);
                break;
            case "WATER_FLOW":
                outputData.write(0x38);
                break;
            case "WATER_PRESSURE":
                outputData.write(0x39);
                break;
            case "RF_SIGNAL_STRENGTH":
                outputData.write(0x3A);
                break;
            case "PARTICULATE_MATTER":
                outputData.write(0x3B);
                break;
            case "RESPIRATORY_RATE":
                outputData.write(0x3C);
                break;
            default:
    ...
    public static Map<String, Object> handleSensorMultilevelSupportedGetScale(byte[] payload) {
        ...
        switch ((int) payload[2]) {
            ...
            case (byte) 0x33:
                ...
                break;
            case (byte) 0x34:
                response.put("SENSOR_TYPE", "ACCELERATION_X_AXIS");
                break;
            case (byte) 0x35:
                response.put("SENSOR_TYPE", "ACCELERATION_Y_AXIS");
                break;
            case (byte) 0x36:
                response.put("SENSOR_TYPE", "ACCELERATION_Z_AXIS");
                break;
            case (byte) 0x37:
                response.put("SENSOR_TYPE", "SMOKE_DENSITY");
                break;
            case (byte) 0x38:
                response.put("SENSOR_TYPE", "WATER_FLOW");
                break;
            case (byte) 0x39:
                response.put("SENSOR_TYPE", "WATER_PRESSURE");
                break;
            case (byte) 0x3A:
                response.put("SENSOR_TYPE", "RF_SIGNAL_STRENGTH");
                break;
            case (byte) 0x3B:
                response.put("SENSOR_TYPE", "PARTICULATE_MATTER");
                break;
            case (byte) 0x3C:
                response.put("SENSOR_TYPE", "RESPIRATORY_RATE");
                break;
            default:
