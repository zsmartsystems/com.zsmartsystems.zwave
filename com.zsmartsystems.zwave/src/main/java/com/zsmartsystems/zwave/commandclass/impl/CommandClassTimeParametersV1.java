...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_TIME_PARAMETERS</b> version <b>1</b>.<br>
 *
 * Command Class Time Parameters<br>
 *
...
public class CommandClassTimeParametersV1 {
    ...
    /**
     * Creates a new message with the TIME_PARAMETERS_SET command.<br>
     *
     * Time Parameters Set<br>
     *
     *
    ...
    /**
     * Processes a received frame with the TIME_PARAMETERS_SET command<br>
     *
     * Time Parameters Set<br>
     *
     *
    ...
    /**
     * Creates a new message with the TIME_PARAMETERS_GET command.<br>
     *
     * Time Parameters Get<br>
     *
     *
     * @return the {@link byte[]} array with the command to send
     */
    ...
    /**
     * Processes a received frame with the TIME_PARAMETERS_GET command<br>
     *
     * Time Parameters Get<br>
     *
     *
    ...
    /**
     * Creates a new message with the TIME_PARAMETERS_REPORT command.<br>
     *
     * Time Parameters Report<br>
     *
     *
     * @param year {@link Integer}
     * @param month {@link Integer}
    ...
    /**
     * Processes a received frame with the TIME_PARAMETERS_REPORT command<br>
     *
     * Time Parameters Report<br>
     *
     *
