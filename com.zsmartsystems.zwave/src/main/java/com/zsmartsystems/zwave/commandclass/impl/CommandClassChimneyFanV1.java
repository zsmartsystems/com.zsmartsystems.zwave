...
public class CommandClassChimneyFanV1 {
    ...
    public static Map<String, Object> handleChimneyFanStateReport(byte[] payload) {
        ...
        switch ((int) payload[2]) {
            case (byte) 0x00:
                ...
                break;
            case (byte) 0x01:
                response.put("STATE", "BOOST");
                break;
            case (byte) 0x02:
                response.put("STATE", "EXHAUST");
                break;
            case (byte) 0x03:
                response.put("STATE", "RELOAD");
                break;
            case (byte) 0x04:
                response.put("STATE", "VENTING");
                break;
            case (byte) 0x05:
                response.put("STATE", "STOP");
                break;
            case (byte) 0x06:
                response.put("STATE", "VENTING_EX");
                break;
            case (byte) 0x07:
                response.put("STATE", "SERVICE");
                break;
            case (byte) 0x08:
                response.put("STATE", "SENSOR_FAILURE");
                break;
            case (byte) 0x09:
                response.put("STATE", "CHIMNEY_FIRE");
                break;
            case (byte) 0x0A:
                response.put("STATE", "EXTERNAL_ALARM");
                break;
            default:
                logger.debug("Unknown value {} for constant 'STATE'", String.format("%02X", payload[2]));
                response.put("STATE", "UNKNOWN_" + String.format("%02X", payload[2]));
    ...
    public static Map<String, Object> handleChimneyFanSetupSet(byte[] payload) {
        ...
        switch ((int) payload[msgOffset]) {
            ...
            case (byte) 0xFF:
                ...
                break;
            default:
                logger.debug("Unknown value {} for constant 'MODE'", String.format("%02X", payload[msgOffset]));
                response.put("MODE", "UNKNOWN_" + String.format("%02X", payload[msgOffset]));
                break;
        }
        msgOffset += 1;
    ...
    public static Map<String, Object> handleChimneyFanStatusReport(byte[] payload) {
        ...
        switch ((int) payload[msgOffset]) {
            ...
            case (byte) 0x0A:
                ...
                break;
            default:
                logger.debug("Unknown value {} for constant 'STATE'", String.format("%02X", payload[msgOffset]));
                response.put("STATE", "UNKNOWN_" + String.format("%02X", payload[msgOffset]));
                break;
        }
        msgOffset += 1;
    ...
    static public byte[] getChimneyFanAlarmLogSet(String message) {
        ...
        switch (message) {
            case "RESET_LOG":
                ...
                break;
            default:
                throw new IllegalArgumentException("Unknown constant value for message: " + message);
        }
    ...
    public static Map<String, Object> handleChimneyFanAlarmLogSet(byte[] payload) {
        ...
        switch ((int) payload[2]) {
            case (byte) 0x08:
                response.put("MESSAGE", "RESET_LOG");
                break;
            default:
                logger.debug("Unknown value {} for constant 'MESSAGE'", String.format("%02X", payload[2]));
                response.put("MESSAGE", "UNKNOWN_" + String.format("%02X", payload[2]));
                break;
        }
