...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_NETWORK_MANAGEMENT_PROXY</b> version <b>1</b>.
 * <p>
...
public class CommandClassNetworkManagementProxyV1 {
    ...
    /**
     * Map holding constants for Security Scheme 0 MARK
     */
    private static Map<Integer, String> constantSecurityScheme0Mark = new HashMap<Integer, String>();
    static {

        // Constants for Properties2
        constantProperties2.put(0x80, "LISTENING");

        // Constants for Status
        constantStatus.put(0x00, "LATEST");
        constantStatus.put(0x01, "MAY_NOT_BE_THE_LATEST");

        // Constants for Properties3
        constantProperties3.put(0x80, "OPT");

        // Constants for Security Scheme 0 MARK
        constantSecurityScheme0Mark.put(0x00, "SECURITY_SCHEME_0_MARK");
        constantSecurityScheme0Mark.put(0xF1, "SECURITY_SCHEME_0_MARK");
    }
