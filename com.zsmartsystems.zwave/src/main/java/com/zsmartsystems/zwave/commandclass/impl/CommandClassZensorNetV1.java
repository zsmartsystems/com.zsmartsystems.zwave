...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_ZENSOR_NET</b> version <b>1</b>.<br>
 * <p>
 * Command Class Zensor Net<br>
 *
...
public class CommandClassZensorNetV1 {
    ...
    /**
     * Creates a new message with the BIND_REQUEST command.<br>
     * <p>
     * Bind Request<br>
     *
    ...
    /**
     * Processes a received frame with the BIND_REQUEST command<br>
     * <p>
     * Bind Request<br>
     *
    ...
    /**
     * Creates a new message with the BIND_ACCEPT command.<br>
     * <p>
     * Bind Accept<br>
     *
     * @return the {@link byte[]} array with the command to send
    ...
    /**
     * Processes a received frame with the BIND_ACCEPT command<br>
     * <p>
     * Bind Accept<br>
     *
     * @param payload the {@link byte[]} payload data to process
    ...
    /**
     * Creates a new message with the BIND_COMPLETE command.<br>
     * <p>
     * Bind Complete<br>
     *
     * @return the {@link byte[]} array with the command to send
    ...
    /**
     * Processes a received frame with the BIND_COMPLETE command<br>
     * <p>
     * Bind Complete<br>
     *
     * @param payload the {@link byte[]} payload data to process
