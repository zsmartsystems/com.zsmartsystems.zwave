...
public class CommandClassEntryControlV1 {
    ...
    /**
     * Map holding constants for Event Type Supported Bit Mask
     */
    private static Map<Integer, String> constantEventTypeSupportedBitMask = new HashMap<Integer, String>();

    /**
     * Map holding constants for Data Type Supported Bit Mask
     */
    private static Map<Integer, String> constantDataTypeSupportedBitMask = new HashMap<Integer, String>();

    /**
     * Map holding constants for Event Type
     */
    private static Map<Integer, String> constantEventType = new HashMap<Integer, String>();
    static {

        // Constants for Event Type Supported Bit Mask
        constantEventTypeSupportedBitMask.put(0x00, "CACHING");
        constantEventTypeSupportedBitMask.put(0x01, "CACHED_KEYS");
        constantEventTypeSupportedBitMask.put(0x02, "ENTER");
        constantEventTypeSupportedBitMask.put(0x03, "DISARM_ALL");
        constantEventTypeSupportedBitMask.put(0x04, "ARM_ALL");
        constantEventTypeSupportedBitMask.put(0x05, "ARM_AWAY");
        constantEventTypeSupportedBitMask.put(0x06, "ARM_HOME");
        constantEventTypeSupportedBitMask.put(0x07, "EXIT_DELAY");
        constantEventTypeSupportedBitMask.put(0x08, "ARM_1");
        constantEventTypeSupportedBitMask.put(0x09, "ARM_2");
        constantEventTypeSupportedBitMask.put(0x0A, "ARM_3");
        constantEventTypeSupportedBitMask.put(0x0B, "ARM_4");
        constantEventTypeSupportedBitMask.put(0x0C, "ARM_5");
        constantEventTypeSupportedBitMask.put(0x0D, "ARM_6");
        constantEventTypeSupportedBitMask.put(0x0E, "RFID");
        constantEventTypeSupportedBitMask.put(0x0F, "BELL");
        constantEventTypeSupportedBitMask.put(0x11, "POLICE");
        constantEventTypeSupportedBitMask.put(0x10, "FIRE");
        constantEventTypeSupportedBitMask.put(0x13, "ALERT_MEDICAL");
        constantEventTypeSupportedBitMask.put(0x12, "ALERT_PANIC");
        constantEventTypeSupportedBitMask.put(0x15, "GATE_CLOSE");
        constantEventTypeSupportedBitMask.put(0x14, "GATE_OPEN");
        constantEventTypeSupportedBitMask.put(0x17, "UNLOCK");
        constantEventTypeSupportedBitMask.put(0x16, "LOCK");
        constantEventTypeSupportedBitMask.put(0x19, "CANCEL");
        constantEventTypeSupportedBitMask.put(0x18, "TEST");

        // Constants for Data Type Supported Bit Mask
        constantDataTypeSupportedBitMask.put(0x00, "NA");
        constantDataTypeSupportedBitMask.put(0x01, "RAW");
        constantDataTypeSupportedBitMask.put(0x02, "ASCII");
        constantDataTypeSupportedBitMask.put(0x03, "MD5");
    ...
    public static Map<String, Object> handleEntryControlEventSupportedReport(byte[] payload) {
        ...
        for (int cntDataTypeSupportedBitMask = 0; cntDataTypeSupportedBitMask < lenDataTypeSupportedBitMask; cntDataTypeSupportedBitMask++) {
            ...
            responseDataTypeSupportedBitMask.add(constantDataTypeSupportedBitMask.get(cntDataTypeSupportedBitMask));
        }
        ...
        for (int cntEventTypeSupportedBitMask = 0; cntEventTypeSupportedBitMask < lenEventTypeSupportedBitMask; cntEventTypeSupportedBitMask++) {
            ...
            responseEventTypeSupportedBitMask.add(constantEventTypeSupportedBitMask.get(cntEventTypeSupportedBitMask));
        }
