...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_METER</b> version <b>3</b>.<br>
 *
...
public class CommandClassMeterV3 {
     ...
     * @return the {@link byte[]} array with the command to send
     */
    static public byte[] getMeterReport(Integer meterType, Integer rateType, Boolean scaleBit2, Integer size,
    ...
    public static Map<String, Object> handleMeterSupportedReport(byte[] payload) {
        ...
        // Process 'Scale Supported'
        response.put("SCALE_SUPPORTED", new Integer(payload[3]));
