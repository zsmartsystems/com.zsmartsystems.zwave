...
public class ZwaveCmdClassV1 {
    ...
    /**
     * Map holding constants for Security
     */
    private static Map<Integer, String> constantSecurity = new HashMap<Integer, String>();

    /**
     * Map holding constants for Capability
     */
    private static Map<Integer, String> constantCapability = new HashMap<Integer, String>();
    static {

        // Constants for Security
        constantSecurity.put(0x10, "BEAM_CAPABILITY");
        constantSecurity.put(0x01, "SECURITY");
        constantSecurity.put(0x20, "SENSOR_250MS");
        constantSecurity.put(0x02, "CONTROLLER");
        constantSecurity.put(0x40, "SENSOR_1000MS");
        constantSecurity.put(0x04, "SPECIFIC_DEVICE");
        constantSecurity.put(0x08, "ROUTING_SLAVE");
        constantSecurity.put(0x80, "OPTIONAL_FUNCTIONALITY");

        // Constants for Capability
        constantCapability.put(0x40, "ROUTING");
        constantCapability.put(0x80, "LISTENING");
    }
