...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_THERMOSTAT_MODE</b> version <b>2</b>.<br>
 * <p>
        ...
        while (cntBitMask < payload.length - 2) {
            ...
            switch (cntBitMask) {
                ...
                case 0x0A:
                    ...
                    break;
                case 0x0B:
                    responseBitMask.add("ENERGY_SAVE_HEAT");
                    break;
                case 0x0C:
                    responseBitMask.add("ENERGY_SAVE_COOL");
                    break;
                case 0x0D:
                    responseBitMask.add("AWAY");
                    break;
                default:
