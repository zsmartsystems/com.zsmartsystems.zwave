...
public class CommandClassSecurityPanelModeV1 {
     ...
     */
    private static Map<Integer, String> constantSecurityPanelModeSetMode = new HashMap<Integer, String>();
    ...
    static {
        ...
        constantSecurityPanelModeSetMode.put(0x03, "ARM_AWAY_DELAYED");
        constantSecurityPanelModeSetMode.put(0x04, "DISARM");
        constantSecurityPanelModeSetMode.put(0x05, "ALARM_TRIGGER");

        // Constants for SecurityPanelModeReportMode
        constantSecurityPanelModeReportMode.put(0x01, "ARM_HOME");
        constantSecurityPanelModeReportMode.put(0x02, "ARM_AWAY_NO_DELAY");
        constantSecurityPanelModeReportMode.put(0x03, "ARM_AWAY_DELAYED");
        constantSecurityPanelModeReportMode.put(0x04, "DISARM");
        constantSecurityPanelModeReportMode.put(0x05, "ALARM_TRIGGER");
    }
    ...
    static public byte[] getSecurityPanelModeReport(String mode) {
        ...
        for (Integer entry : constantSecurityPanelModeReportMode.keySet()) {
            if (constantSecurityPanelModeReportMode.get(entry).equals(mode)) {
    ...
    public static Map<String, Object> handleSecurityPanelModeReport(byte[] payload) {
        ...
        // Process 'MODE'
        response.put("MODE", constantSecurityPanelModeReportMode.get(payload[2] & 0xff));
    ...
    static public byte[] getSecurityPanelModeSet(String mode) {
        ...
        // Process 'MODE'
        boolean foundMode = false;
        for (Integer entry : constantSecurityPanelModeSetMode.keySet()) {
            if (constantSecurityPanelModeSetMode.get(entry).equals(mode)) {
                outputData.write(entry);
                foundMode = true;
                break;
            }
    ...
    public static Map<String, Object> handleSecurityPanelModeSet(byte[] payload) {
        ...
        // Process 'MODE'
        response.put("MODE", constantSecurityPanelModeSetMode.get(payload[2] & 0xff));
