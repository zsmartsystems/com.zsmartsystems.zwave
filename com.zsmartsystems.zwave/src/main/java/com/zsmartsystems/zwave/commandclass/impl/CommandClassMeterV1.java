...
public class CommandClassMeterV1 {
    ...
    /**
     * Map holding constants for Meter Type
     */
    private static Map<Integer, String> constantMeterType = new HashMap<Integer, String>();
    static {

        // Constants for Meter Type
        constantMeterType.put(0x01, "ELECTRIC_METER");
        constantMeterType.put(0x02, "GAS_METER");
        constantMeterType.put(0x03, "WATER_METER");
    }
    ...
    static public byte[] getMeterReport(String meterType, Integer scale, Integer precision, byte[] meterValue) {
        ...
        for (Integer entry : constantMeterType.keySet()) {
            if (constantMeterType.get(entry).equals(meterType)) {
