...
public class CommandClassSilenceAlarmV1 {
    ...
    static {
        ...
        // Constants for Mode
        constantMode.put(0x00, "DISABLE_SOUNDING_OF_ALL_SENSOR_ALARMS");
        constantMode.put(0x01, "DISABLE_SOUNDING_OF_ALL_SENSOR_ALARMS_INDEPENDENT_OF_BIT_MASK_WHICH_HAVE_RECEIVED_THE_ALARM");
        constantMode.put(0x02, "DISABLE_SOUNDING_OF_ALL_SENSOR_ALARMS_ACCORDING_TO_BIT_MASK");
        constantMode.put(0x03, "DISABLE_SOUNDING_OF_ALL_SENSOR_ALARMS_ACCORDING_TO_BIT_MASK_WHICH_HAVE_RECEIVED_THE_ALARM");
    }
