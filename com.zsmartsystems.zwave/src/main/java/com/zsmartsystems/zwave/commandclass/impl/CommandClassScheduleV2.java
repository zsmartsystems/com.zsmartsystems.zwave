...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_SCHEDULE</b> version <b>2</b>.<br>
 *
 ...
 */
public class CommandClassScheduleV2 {
    private static final Logger logger = LoggerFactory.getLogger(CommandClassScheduleV2.class);
    ...
    static public byte[] getScheduleSupportedGet(Integer scheduleIdBlock) {
        logger.debug("Creating command message SCHEDULE_SUPPORTED_GET version 2");
    ...
    static public byte[] getScheduleSupportedReport(Integer numberOfSupportedScheduleId, Integer startTimeSupport,
        ...
        logger.debug("Creating command message SCHEDULE_SUPPORTED_REPORT version 2");
    ...
    static public byte[] getCommandScheduleSet(Integer scheduleId, Integer scheduleIdBlock, Integer startYear,
        ...
        logger.debug("Creating command message COMMAND_SCHEDULE_SET version 2");
     ...
     * @return the {@link byte[]} array with the command to send
     */
    static public byte[] getCommandScheduleGet(Integer scheduleId, Integer scheduleIdBlock) {
        logger.debug("Creating command message COMMAND_SCHEDULE_GET version 2");
    ...
    static public byte[] getCommandScheduleReport(Integer scheduleId, Integer scheduleIdBlock, Integer startYear,
        ...
        logger.debug("Creating command message COMMAND_SCHEDULE_REPORT version 2");
    ...
    public static Map<String, Object> handleCommandScheduleReport(byte[] payload) {
        ...
        // Process 'Properties1'
        response.put("START_MONTH", new Integer(payload[msgOffset] & 0x0F));
        response.put("ACTIVE_ID", new Integer((payload[msgOffset] & 0xF0 >> 4)));
        msgOffset += 1;
    ...
    static public byte[] getScheduleRemove(Integer scheduleId, Integer scheduleIdBlock) {
        logger.debug("Creating command message SCHEDULE_REMOVE version 2");
    ...
    static public byte[] getScheduleStateSet(Integer scheduleId, Integer scheduleState, Integer scheduleIdBlock) {
        logger.debug("Creating command message SCHEDULE_STATE_SET version 2");
    ...
    static public byte[] getScheduleStateGet(Integer scheduleIdBlock) {
        logger.debug("Creating command message SCHEDULE_STATE_GET version 2");
    ...
    static public byte[] getScheduleStateReport(Integer numberOfSupportedScheduleId, Boolean override,
        ...
        logger.debug("Creating command message SCHEDULE_STATE_REPORT version 2");
