...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_MANUFACTURER_PROPRIETARY_FIBARO_FGRM222</b> version <b>1</b>.
 * <p>
...
public class CommandClassManufacturerProprietaryFibaroFgrm222V1 {
    private static final Logger logger = LoggerFactory.getLogger(CommandClassManufacturerProprietaryFibaroFgrm222V1.class);
    ...
    /**
     * Map holding constants for Command
     */
    private static Map<Integer, String> constantCommand = new HashMap<Integer, String>();

    /**
     * Map holding constants for Constant3
     */
    private static Map<Integer, String> constantConstant3 = new HashMap<Integer, String>();

    /**
     * Map holding constants for Constant2
     */
    private static Map<Integer, String> constantConstant2 = new HashMap<Integer, String>();

    /**
     * Map holding constants for Constant1
     */
    private static Map<Integer, String> constantConstant1 = new HashMap<Integer, String>();
    static {

        // Constants for Command
        constantCommand.put(0x01, "SHUTTER");
        constantCommand.put(0x02, "LAMELLA");

        // Constants for Constant3

        // Constants for Constant2

        // Constants for Constant1
    }
    ...
    static public byte[] getFgrm222Set(String command, Integer shutterPosition, Integer lamellaPosition) {
        ...
        for (Integer entry : constantCommand.keySet()) {
            if (constantCommand.get(entry).equals(command)) {
