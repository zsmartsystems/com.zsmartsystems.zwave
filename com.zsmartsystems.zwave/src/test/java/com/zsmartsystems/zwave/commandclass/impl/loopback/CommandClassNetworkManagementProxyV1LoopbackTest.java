...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassNetworkManagementProxyV1;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_NETWORK_MANAGEMENT_PROXY</b> version <b>1</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassNetworkManagementProxyV1LoopbackTest {
    /**
    ...
    public static void testNodeListGetLoopback(Integer seqNo) {
        byte[] testPayload = CommandClassNetworkManagementProxyV1.getNodeListGet(seqNo);

        Map<String, Object> response = CommandClassNetworkManagementProxyV1.handleNodeListGet(testPayload);
    ...
    public static void testNodeListReportLoopback(Integer seqNo, String status, Integer nodeListControllerId,
        ...
        byte[] testPayload = CommandClassNetworkManagementProxyV1.getNodeListReport(seqNo, status, nodeListControllerId,
                nodeListData);

        Map<String, Object> response = CommandClassNetworkManagementProxyV1.handleNodeListReport(testPayload);
        assertEquals(seqNo, (Integer) response.get("SEQ_NO"));
    ...
    public static void testNodeInfoCachedGetLoopback(Integer seqNo, Integer maxAge, Integer nodeId) {
        byte[] testPayload = CommandClassNetworkManagementProxyV1.getNodeInfoCachedGet(seqNo, maxAge, nodeId);

        Map<String, Object> response = CommandClassNetworkManagementProxyV1.handleNodeInfoCachedGet(testPayload);
        assertEquals(seqNo, (Integer) response.get("SEQ_NO"));
    ...
    public static void testNodeInfoCachedReportLoopback(Integer seqNo, Integer age, String status, Integer capability,
        ...
        byte[] testPayload = CommandClassNetworkManagementProxyV1.getNodeInfoCachedReport(seqNo, age, status, capability,
                listening, security, sensor, opt, basicDeviceClass, genericDeviceClass, specificDeviceClass,
                nonSecureCommandClass, securityScheme0CommandClass);

        Map<String, Object> response = CommandClassNetworkManagementProxyV1.handleNodeInfoCachedReport(testPayload);
        assertEquals(seqNo, (Integer) response.get("SEQ_NO"));
