...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassAssociationGrpInfoV1;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_ASSOCIATION_GRP_INFO</b> version <b>1</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassAssociationGrpInfoV1LoopbackTest {
    /**
    ...
    public static void testAssociationGroupNameGetLoopback(Integer groupingIdentifier) {
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupNameGet(groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupNameGet(testPayload);
    ...
    public static void testAssociationGroupNameReportLoopback(Integer groupingIdentifier, Integer lengthOfName,
            byte[] name) {
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupNameReport(groupingIdentifier,
                lengthOfName, name);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupNameReport(testPayload);
        assertEquals(groupingIdentifier, (Integer) response.get("GROUPING_IDENTIFIER"));
    ...
    public static void testAssociationGroupInfoGetLoopback(Boolean listMode, Boolean refreshCache,
        ...
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupInfoGet(listMode, refreshCache,
                groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupInfoGet(testPayload);
    ...
    public static void testAssociationGroupInfoReportLoopback(Integer groupCount, Boolean dynamicInfo, Boolean listMode) {
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupInfoReport(groupCount, dynamicInfo,
                listMode);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupInfoReport(testPayload);
    ...
    public static void testAssociationGroupCommandListGetLoopback(Boolean allowCache, Integer groupingIdentifier) {
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupCommandListGet(allowCache,
                groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupCommandListGet(testPayload);
    ...
    public static void testAssociationGroupCommandListReportLoopback(Integer groupingIdentifier, Integer listLength,
            byte[] command) {
        byte[] testPayload = CommandClassAssociationGrpInfoV1.getAssociationGroupCommandListReport(groupingIdentifier,
                listLength, command);

        Map<String, Object> response = CommandClassAssociationGrpInfoV1.handleAssociationGroupCommandListReport(testPayload);
        assertEquals(groupingIdentifier, (Integer) response.get("GROUPING_IDENTIFIER"));
