...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassConfigurationV3;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_CONFIGURATION</b> version <b>3</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassConfigurationV3LoopbackTest {
    /**
    ...
    public static void testConfigurationSetLoopback(Integer parameterNumber, Boolean defaultValue,
        ...
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationSet(parameterNumber, defaultValue,
                configurationValue);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationSet(testPayload);
    ...
    public static void testConfigurationGetLoopback(Integer parameterNumber) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationGet(parameterNumber);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationGet(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
    }
    ...
    public static void testConfigurationReportLoopback(Integer parameterNumber, byte[] configurationValue) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationReport(parameterNumber, configurationValue);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationReport(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
        assertEquals(configurationValue, (byte[]) response.get("CONFIGURATION_VALUE"));
    }
    ...
    public static void testConfigurationBulkSetLoopback(Integer parameterOffset, Integer numberOfParameters,
        ...
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationBulkSet(parameterOffset, numberOfParameters,
                size, handshake, defaultValue);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationBulkSet(testPayload);
    ...
    public static void testConfigurationBulkGetLoopback(Integer parameterOffset, Integer numberOfParameters) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationBulkGet(parameterOffset, numberOfParameters);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationBulkGet(testPayload);
        assertEquals(parameterOffset, (Integer) response.get("PARAMETER_OFFSET"));
        assertEquals(numberOfParameters, (Integer) response.get("NUMBER_OF_PARAMETERS"));
    }
    ...
    public static void testConfigurationBulkReportLoopback(Integer parameterOffset, Integer numberOfParameters,
        ...
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationBulkReport(parameterOffset, numberOfParameters,
                reportsToFollow, size, handshake, defaultValue);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationBulkReport(testPayload);
        assertEquals(parameterOffset, (Integer) response.get("PARAMETER_OFFSET"));
        assertEquals(numberOfParameters, (Integer) response.get("NUMBER_OF_PARAMETERS"));
    ...
    public static void testConfigurationNameGetLoopback(Integer parameterNumber) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationNameGet(parameterNumber);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationNameGet(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
    }
    ...
    public static void testConfigurationNameReportLoopback(Integer parameterNumber, Integer reportsToFollow, byte[] name) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationNameReport(parameterNumber, reportsToFollow,
                name);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationNameReport(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
        assertEquals(reportsToFollow, (Integer) response.get("REPORTS_TO_FOLLOW"));
    ...
    public static void testConfigurationInfoGetLoopback(Integer parameterNumber) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationInfoGet(parameterNumber);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationInfoGet(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
    }
    ...
    public static void testConfigurationInfoReportLoopback(Integer parameterNumber, Integer reportsToFollow, byte[] info) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationInfoReport(parameterNumber, reportsToFollow,
                info);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationInfoReport(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
        assertEquals(reportsToFollow, (Integer) response.get("REPORTS_TO_FOLLOW"));
    ...
    public static void testConfigurationPropertiesGetLoopback(Integer parameterNumber) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationPropertiesGet(parameterNumber);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationPropertiesGet(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
    }
     ...
     */
    public static void testConfigurationPropertiesReportLoopback(Integer parameterNumber, String format, byte[] minValue,
            byte[] maxValue, byte[] defaultValue, Integer nextParameterNumber) {
        byte[] testPayload = CommandClassConfigurationV3.getConfigurationPropertiesReport(parameterNumber, format,
                minValue, maxValue, defaultValue, nextParameterNumber);

        Map<String, Object> response = CommandClassConfigurationV3.handleConfigurationPropertiesReport(testPayload);
        assertEquals(parameterNumber, (Integer) response.get("PARAMETER_NUMBER"));
