...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassZipV2;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_ZIP</b> version <b>2</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassZipV2LoopbackTest {
    /**
    ...
    public static void testCommandZipPacketLoopback(Boolean nackOptionError, Boolean nackQueueFull, Boolean nackWaiting,
            ...
            byte[] zWaveCommand) {
        byte[] testPayload = CommandClassZipV2.getCommandZipPacket(nackOptionError, nackQueueFull, nackWaiting,
        ...
        Map<String, Object> response = CommandClassZipV2.handleCommandZipPacket(testPayload);
