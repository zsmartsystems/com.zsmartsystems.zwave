...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassNotificationV3;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_NOTIFICATION</b> version <b>3</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassNotificationV3LoopbackTest {
    /**
    ...
    public static void testEventSupportedGetLoopback(String notificationType) {
        byte[] testPayload = CommandClassNotificationV3.getEventSupportedGet(notificationType);

        Map<String, Object> response = CommandClassNotificationV3.handleEventSupportedGet(testPayload);
    ...
    public static void testEventSupportedReportLoopback(String notificationType, List<Integer> bitMask) {
        byte[] testPayload = CommandClassNotificationV3.getEventSupportedReport(notificationType, bitMask);

        Map<String, Object> response = CommandClassNotificationV3.handleEventSupportedReport(testPayload);
        assertEquals(notificationType, (String) response.get("NOTIFICATION_TYPE"));
    ...
    public static void testNotificationGetLoopback(Integer v1AlarmType, String notificationType, Integer event) {
        byte[] testPayload = CommandClassNotificationV3.getNotificationGet(v1AlarmType, notificationType, event);

        Map<String, Object> response = CommandClassNotificationV3.handleNotificationGet(testPayload);
    ...
    public static void testNotificationReportLoopback(Integer v1AlarmType, Integer v1AlarmLevel,
        ...
        byte[] testPayload = CommandClassNotificationV3.getNotificationReport(v1AlarmType, v1AlarmLevel,
                notificationStatus, notificationType, event, sequence, eventParameter, sequenceNumber);

        Map<String, Object> response = CommandClassNotificationV3.handleNotificationReport(testPayload);
        assertEquals(v1AlarmType, (Integer) response.get("V1_ALARM_TYPE"));
    ...
    public static void testNotificationSetLoopback(String notificationType, String notificationStatus) {
        byte[] testPayload = CommandClassNotificationV3.getNotificationSet(notificationType, notificationStatus);

        Map<String, Object> response = CommandClassNotificationV3.handleNotificationSet(testPayload);
        assertEquals(notificationType, (String) response.get("NOTIFICATION_TYPE"));
        assertEquals(notificationStatus, (String) response.get("NOTIFICATION_STATUS"));
    }
    ...
    public static void testNotificationSupportedReportLoopback(Boolean v1Alarm, List<String> bitMask) {
        byte[] testPayload = CommandClassNotificationV3.getNotificationSupportedReport(v1Alarm, bitMask);

        Map<String, Object> response = CommandClassNotificationV3.handleNotificationSupportedReport(testPayload);
