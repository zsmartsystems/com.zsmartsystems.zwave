...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassAssociationGrpInfoV3;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_ASSOCIATION_GRP_INFO</b> version <b>3</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassAssociationGrpInfoV3LoopbackTest {
    /**
    ...
    public static void testAssociationGroupNameGetLoopback(Integer groupingIdentifier) {
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupNameGet(groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupNameGet(testPayload);
    ...
    public static void testAssociationGroupNameReportLoopback(Integer groupingIdentifier, Integer lengthOfName,
            byte[] name) {
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupNameReport(groupingIdentifier,
                lengthOfName, name);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupNameReport(testPayload);
        assertEquals(groupingIdentifier, (Integer) response.get("GROUPING_IDENTIFIER"));
    ...
    public static void testAssociationGroupInfoGetLoopback(Boolean listMode, Boolean refreshCache,
        ...
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupInfoGet(listMode, refreshCache,
                groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupInfoGet(testPayload);
    ...
    public static void testAssociationGroupInfoReportLoopback(Integer groupCount, Boolean dynamicInfo, Boolean listMode) {
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupInfoReport(groupCount, dynamicInfo,
                listMode);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupInfoReport(testPayload);
    ...
    public static void testAssociationGroupCommandListGetLoopback(Boolean allowCache, Integer groupingIdentifier) {
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupCommandListGet(allowCache,
                groupingIdentifier);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupCommandListGet(testPayload);
    ...
    public static void testAssociationGroupCommandListReportLoopback(Integer groupingIdentifier, Integer listLength,
            byte[] command) {
        byte[] testPayload = CommandClassAssociationGrpInfoV3.getAssociationGroupCommandListReport(groupingIdentifier,
                listLength, command);

        Map<String, Object> response = CommandClassAssociationGrpInfoV3.handleAssociationGroupCommandListReport(testPayload);
        assertEquals(groupingIdentifier, (Integer) response.get("GROUPING_IDENTIFIER"));
