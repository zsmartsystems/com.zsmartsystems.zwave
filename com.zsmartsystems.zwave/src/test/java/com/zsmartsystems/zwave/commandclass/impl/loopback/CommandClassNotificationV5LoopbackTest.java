...
import com.zsmartsystems.zwave.commandclass.impl.CommandClassNotificationV5;

/**
 * Class to implement loopback tests for command class <b>COMMAND_CLASS_NOTIFICATION</b> version <b>5</b>.
 * <p>
 * Note that this code is autogenerated. Manual changes may be overwritten.
 *
 * @author Chris Jackson - Initial contribution of Java code generator
 */
public class CommandClassNotificationV5LoopbackTest {
    /**
    ...
    public static void testEventSupportedGetLoopback(String notificationType) {
        byte[] testPayload = CommandClassNotificationV5.getEventSupportedGet(notificationType);

        Map<String, Object> response = CommandClassNotificationV5.handleEventSupportedGet(testPayload);
    ...
    public static void testEventSupportedReportLoopback(String notificationType, List<Integer> bitMask) {
        byte[] testPayload = CommandClassNotificationV5.getEventSupportedReport(notificationType, bitMask);

        Map<String, Object> response = CommandClassNotificationV5.handleEventSupportedReport(testPayload);
        assertEquals(notificationType, (String) response.get("NOTIFICATION_TYPE"));
    ...
    public static void testNotificationGetLoopback(Integer v1AlarmType, String notificationType, Integer event) {
        byte[] testPayload = CommandClassNotificationV5.getNotificationGet(v1AlarmType, notificationType, event);

        Map<String, Object> response = CommandClassNotificationV5.handleNotificationGet(testPayload);
    ...
    public static void testNotificationReportLoopback(Integer v1AlarmType, Integer v1AlarmLevel,
        ...
        byte[] testPayload = CommandClassNotificationV5.getNotificationReport(v1AlarmType, v1AlarmLevel,
                notificationStatus, notificationType, event, sequence, eventParameter, sequenceNumber);

        Map<String, Object> response = CommandClassNotificationV5.handleNotificationReport(testPayload);
        assertEquals(v1AlarmType, (Integer) response.get("V1_ALARM_TYPE"));
    ...
    public static void testNotificationSetLoopback(String notificationType, String notificationStatus) {
        byte[] testPayload = CommandClassNotificationV5.getNotificationSet(notificationType, notificationStatus);

        Map<String, Object> response = CommandClassNotificationV5.handleNotificationSet(testPayload);
        assertEquals(notificationType, (String) response.get("NOTIFICATION_TYPE"));
        assertEquals(notificationStatus, (String) response.get("NOTIFICATION_STATUS"));
    }
    ...
    public static void testNotificationSupportedReportLoopback(Boolean v1Alarm, List<String> bitMask) {
        byte[] testPayload = CommandClassNotificationV5.getNotificationSupportedReport(v1Alarm, bitMask);

        Map<String, Object> response = CommandClassNotificationV5.handleNotificationSupportedReport(testPayload);
